...
- 插件仓库：[点我跳转](https://hub.fastgit.org/darlal/obsidian-switcher-plus)
...
- 插件仓库：[点我跳转](https://hub.fastgit.org/lynchjames/obsidian-day-planner)
...
- 插件作者：death_au
- 插件说明：编辑模式下高亮代码块
- 插件仓库：[点我跳转](https://hub.fastgit.org/deathau/cm-editor-syntax-highlight-obsidian)
...
- 插件仓库：[点我跳转](https://hub.fastgit.org/ryanjamurphy/review-obsidian)
...
- 插件作者：@kepano
- 插件说明：更改颜色、字体和其他外观设置
- 插件仓库：[点我跳转](https://hub.fastgit.org/kepano/obsidian-advanced-appearance)
...
- 插件仓库：[点我跳转](https://hub.fastgit.org/kepano/obsidian-hider)
...
- 插件作者：@kepano
- 插件说明：控制最小主题中的颜色和字体
- 插件仓库：[点我跳转](https://hub.fastgit.org/kepano/obsidian-minimal-settings)

> 这个插件配合[Minimal Theme](https://hub.fastgit.org/kepano/obsidian-minimal)主题使用，如果你用的是这个主题，可以详细了解。
...
- 插件仓库：[点我跳转](https://hub.fastgit.org/kepano/obsidian-system-dark-mode)
...
- 插件仓库：[点我跳转](https://hub.fastgit.org/lukeleppan/obsidian-discordrpc)
...
- 插件作者：SilentVoid
- 插件说明：创建和使用模板
- 插件仓库：[点我跳转](https://hub.fastgit.org/SilentVoid13/Templater)
